...
";
            ...
            //var input = s_Input.Split('\n').ToList();
            var checkSums = new List<int>();
            // input.Add("4347	3350	196	162	233	4932	4419	3485	4509	4287	4433	4033	207	3682	2193	4223");
            ...
            for (int i = 0; i < input.Count; i++)
            {
                int max = 0;
                int min = 0;
                var numberGroups = input[i].Split('\t').Select(x => int.Parse(x)).ToList();
